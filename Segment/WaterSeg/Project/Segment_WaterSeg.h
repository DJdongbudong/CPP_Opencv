...
public:
	Segment_WaterSeg();
	~Segment_WaterSeg();
	void Segment_WaterSegment(Mat Mat_Image, Mat& Mat_dst, Mat& Mat_dst_bw, Point No_ROI = Point(0, 0));
private:

};

Segment_WaterSeg::Segment_WaterSeg()
{
}
...
void Segment_WaterSeg::Segment_WaterSegment(Mat Mat_Image, Mat& Mat_dst, Mat& Mat_dst_bw, Point No_ROI)
{
